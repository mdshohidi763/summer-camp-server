...
const uri = "mongodb+srv://shohidi76333:qWR8NwKJFmsaWH3w@cluster0.auirjhu.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
    try {
        ...
        const usersCollection = client.db('assignment-12').collection("userCol");
        const allclassCollection = client.db('assignment-12').collection("allclass");
        const selectclassCollection = client.db('assignment-12').collection("selectClass");
